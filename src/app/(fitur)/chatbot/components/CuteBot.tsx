...
function CuteBot() {
  ...
  return (
    <div id="chatbot" ref={containerRef}>
      ...
      >
        <path d="M29.9988 24.148L5.8512 0L-5.0344e-05 5.85133L24.1476 29.9993L29.9988 24.148Z" fill="#16A34A" />
        <path d="M24.1487 0.00046199L0.00109863 24.1484L5.85235 29.9998L30 5.8518L24.1487 0.00046199Z" fill="#22C55E" />
      </svg>
      <svg
        id="head"
        className="robot-layer"
