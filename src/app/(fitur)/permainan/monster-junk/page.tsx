...
import player1 from "../../../../../public/logo/lari kanan.webp";
import playerMirror1 from "../../../../../public/logo/lari kiri.webp";
  ...
  useEffect(() => {
    const fetchCanvas = () => {
      ...
      joystick?.addEventListener("touchmove", (e) => {
        ...
        const dist = Math.min(
          Math.sqrt(analog.dx * analog.dx + analog.dy * analog.dy),
          40
        );
      ...
      function drawTrash() {
        for (const item of spawnedTrash) {
          context?.drawImage(
            item.image as CanvasImageSource,
            item.x,
            item.y,
            item.size,
            item.size
      ...
      function drawPlayer() {
        context!.save();
        context!.translate(
          playerProp.x + playerProp.size / 2,
          playerProp.y + playerProp.size / 2
        );
        context!.rotate(playerProp.angle);

        if (keys.a || analog.dx < 0) {
          context!.drawImage(
            playerMirror1 as CanvasImageSource,
            -playerProp.size / 2,
            -playerProp.size / 2,
            playerProp.sizeX,
            playerProp.sizeY
      ...
      function drawEnemy() {
        context!.save();
        context!.translate(
          enemyProp.x + enemyProp.sizeX / 2,
          enemyProp.y + enemyProp.sizeY / 2
        );
        context!.drawImage(
          enemy as CanvasImageSource,
          -enemyProp.sizeX / 2,
          -enemyProp.sizeY / 2,
          enemyProp.sizeX,
          enemyProp.sizeY
        ...
        if (isPlayerRight) {
          context!.drawImage(
            enemyMirror as CanvasImageSource,
            -enemyProp.sizeX / 2,
            -enemyProp.sizeY / 2,
            enemyProp.sizeX,
            enemyProp.sizeY
