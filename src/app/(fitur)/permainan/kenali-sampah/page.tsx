...
import background from "../../../../../public/image/kenali/background1.webp";
import life1 from "../../../../../public/image/kenali/life1.webp";
import life2 from "../../../../../public/image/kenali/life2.webp";
import life3 from "../../../../../public/image/kenali/life3.webp";
import life4 from "../../../../../public/image/kenali/life4.webp";
import trash1 from "../../../../../public/image/kenali/trash1.webp";
import trash2 from "../../../../../public/image/kenali/trash2.webp";
import trash3 from "../../../../../public/image/kenali/trash3.webp";
import trash4 from "../../../../../public/image/kenali/trash4.webp";
import img1 from "../../../../../public/image/kenali/trash/1.webp";
import img2 from "../../../../../public/image/kenali/trash/2.webp";
import img3 from "../../../../../public/image/kenali/trash/3.webp";
import img4 from "../../../../../public/image/kenali/trash/4.webp";
import img5 from "../../../../../public/image/kenali/trash/5.webp";
import img6 from "../../../../../public/image/kenali/trash/6.webp";
import img7 from "../../../../../public/image/kenali/trash/7.webp";
import img8 from "../../../../../public/image/kenali/trash/8.webp";
import img9 from "../../../../../public/image/kenali/trash/9.webp";
...
export default function Page() {
  ...
  useEffect(() => {
    const fetchCanvas = () => {
      ...
      function checkTrashCollusion() {
        ...
        const spacing = 20;
        const totalWidth =
          trashProp.sizeX * totalItems + spacing * (totalItems - 1);
      ...
      function drawLife() {
        ...
        if (playerLifeCount === 4) {
          context?.drawImage(
            life1 as CanvasImageSource,
            drawX,
            playerLifeProp.y,
            playerLifeProp.sizeX,
            playerLifeProp.sizeY
          );
        } else if (playerLifeCount === 3) {
          context?.drawImage(
            life2 as CanvasImageSource,
            drawX,
            playerLifeProp.y,
            playerLifeProp.sizeX,
            playerLifeProp.sizeY
      ...
      function drawTrashObject() {
        context?.drawImage(
          trashObjectData[thisTrashObject].image as CanvasImageSource,
          trashObjectProp.x,
          trashObjectProp.y,
          trashObjectProp.size,
          trashObjectProp.size
        );
      }
  ...
  return (
    <div className="fixed font-pixelify">
      ...
      <div
        className={`bg-black rotate-phone w-full h-screen absolute top-0 flex flex-col justify-center items-center ${
          isLoading == false ? "z-40" : "z-0"
        }`}
        id="playScreen"
      >
        <video
