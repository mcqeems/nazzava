  ...
  return (
    <div className="flex flex-col items-center lg:justify-center justify-start lg:py-0 py-2 min-h-screen font-poppins bg-[linear-gradient(150deg,_#58C229_30%,_#C7DF67_100%)]">
      ...
      <div className="flex lg:flex-row flex-col lg:mt-10 mt-6 justify-center items-start lg:gap-24 gap-12 h-auto w-[86vw] rounded-lg lg:px-8 px-6 py-12 bg-white">
        <div
          className={`flex flex-col text-center gap-4 justify-center items-center border-2 ${
            isDragging ? 'border-green-500 bg-green-50' : 'border-[#00AD03]'
          } border-dashed p-6 rounded-xl transition-colors`}
          onDragOver={handleDragOver}
          onDragLeave={handleDragLeave}
          onDrop={handleDrop}
        >
          <Image
            src="/image/scan/upload.webp"
            width={200}
            height={200}
            alt="image"
            className="lg:w-[80px] w-[50px] cursor-pointer h-auto"
          ...
          <Link href="/scan/kamera">
            <button className="bg-[#84D300] mt-4 text-white rounded-full border-[#84D300] border-2 px-8 py-2 hover:bg-transparent hover:text-[#84D300] lg:text-[16px] text-[14px] cursor-pointer font-[500] duration-200">
              Kamera
            </button>
          </Link>
          <p className="text-[#21212144] font-[500] lg:text-[14px] text-[12px]">
            File yang didukung: JPG, JPEG, PNG, WEBP
          </p>
        </div>
            ...
            {previewUrl ? (
              <div>
                <Image
                  ...
                  height={200}
                  alt="preview"
                  className="object-cover h-[30vh] rounded-lg"
                />
                <button
                  onClick={handleSubmit}
                  className="bg-[#84D300] mt-6 text-white rounded-lg border-[#84D300] border-2 px-8 py-2 hover:bg-transparent hover:text-[#84D300] text-[16px] cursor-pointer font-[500] duration-200"
                >
                  Kirim
                </button>
              </div>
