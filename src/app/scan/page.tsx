  ...
  return (
    <div className='flex flex-col text-white items-center justify-center h-screen font-poppins bg-[linear-gradient(150deg,#58C229_30%,#C7DF67_100%)]'>
      ...
      <div className="text-center relative z-20 flex flex-col gap-2 lg:px-0 px-6" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p className='font-medium lg:text-[18px] text-[12px] lg:w-165 w-full'>Selamat datang di fitur Scan SampahMu! Di sini, kamu bisa mengetahui jenis sampahmu dan melihat ide daur ulangnya menjadi kreasi yang bermanfaat. Temukan cara cerdas untuk mendaur ulang dan ubah limbah jadi karya kreatif bersama Greenly.</p>
        <Link href="/scan/pilih">
            <button className='text-[#00AD03] font-semibold mt-8 bg-white rounded-xl px-12 py-2 border-2 border-white lg:text-[20px] text-[14px] hover:bg-transparent hover:text-white duration-200 cursor-pointer w-fit mx-auto'>Mulai</button>
        </Link>
      </div>
