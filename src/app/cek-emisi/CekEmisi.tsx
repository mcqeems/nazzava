              ...
              <div className="space-y-6 w-full">
                ...
                <div className="bg-white rounded-2xl shadow-[0_20px_60px_rgba(10,60,20,0.12)] p-5 lg:p-7 space-y-6">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      <h2 className="text-xl lg:text-2xl font-semibold text-[#0C1F11]">
                        Pilih Transportasi
                      </h2>
                      <p className="text-sm text-[#0C1F11]/70">
                    ...
                    {transportasiData.map((item) => (
                      ...
                      >
                        ...
                        <div className="relative flex flex-col items-start gap-3 p-4 lg:p-5">
                          ...
                          <p className="text-lg lg:text-xl font-semibold text-[#0C1F11]">
                            {item.name}
                          </p>
                          <p className="text-xs text-[#0C1F11]/70">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {guideSteps.map((step, idx) => (
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm font-semibold text-[#0C1F11]">
                            {step.title}
                          </p>
                          <p className="text-xs text-[#0C1F11]/70">
                            {step.detail}
              ...
              <div className="space-y-4 w-full">
                <div className="bg-white rounded-2xl shadow-[0_18px_50px_rgba(10,60,20,0.12)] p-5 lg:p-7 flex flex-col gap-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs uppercase tracking-[0.25em] text-[#0F8A3B]">
                        Ringkasan
                      </p>
                      <h3 className="text-xl font-semibold text-[#0C1F11]">
                        Pilihanmu
                      </h3>
                    </div>
                  ...
                  <div className="border-t border-[#E6F0DF] pt-4 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl lg:text-4xl font-bold text-[#0F8A3B]">
                        {formattedTotal}
                      </p>
                      <p className="text-xs text-[#0C1F11]/60">
