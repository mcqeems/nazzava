  ...
  return (
    <div className='flex lg:flex-row flex-col-reverse justify-center items-center w-full mb-12 lg:px-0 px-6 h-[110vh] lg:h-screen mx-auto lg:gap-30 gap-10 lg:pt-10 pt-24'>
      <div className="lg:w-150 w-full flex flex-col gap-6" data-aos="fade-right" data-aos-duration="900">
        <h1 className='bg-clip-text text-transparent bg-[radial-gradient(circle,#6BB3F6_0%,#7597B8_100%)] font-semibold lg:text-[42px] text-[24px]'>Aksi Kecil, Dampak Besar Untuk Lingkungan</h1>
