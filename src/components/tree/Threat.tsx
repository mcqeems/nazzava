...
export default function Threat() {
  ...
  return (
    <div className='flex justify-center lg:flex-row flex-col items-center gap-16 lg:mt-0 -mt-60 font-poppins min-h-auto mb-28' id='ancaman'>
      <h1 className='lg:text-[42px] text-[30px] lg:text-start text-center font-bold text-transparent bg-clip-text bg-[linear-gradient(160deg,#BDFF00_0%,#00AD03_81%)]' data-aos="fade-right" data-aos-duration="800">ANCAMAN <br /> PENCEMARAN</h1>
