...
export default function Impact() {
  return (
    <div className="h-auto pb-20 font-poppins text-foreground">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="300">
              <div className="p-[4px] cursor-pointer h-auto lg:w-full w-[80vw] mx-auto rounded-xl bg-[linear-gradient(150deg,_#58C229_30%,_#C7DF67_100%)] group hover:scale-105 duration-200" >
                <div className="bg-background lg:h-[100px] h-[70px] rounded-xl py-4 lg:px-10 px-6 relative flex flex-col justify-center items-start">
        ...
        <div className="w-full lg:h-screen h-[190vh] object-cover bg-cover -mt-12" style={{backgroundImage: `url(${background.src})`}}>
            <div className="bg-background rounded-b-lg w-[94vw] lg:h-[58vh] h-auto lg:pb-0 pb-20 flex flex-col justify- gap-10 pt-26 mx-auto">
                <div className="flex lg:flex-row flex-col lg:justify-between justify-center items-center lg:gap-0 gap-2 lg:px-20 px-6">
                    ...
                    <p className='lg:text-end text-center lg:text-[18px] text-[12px] text-foreground lg:w-[600px] w-auto' data-aos="fade-left" data-aos-duration="800" data-aos-delay="400">Perubahan iklim membuat suhu global naik, memicu gelombang panas, kekeringan ekstrem, dan kebakaran hutan lebih sering.</p>
                </div>
                <div className="flex lg:flex-row flex-col justify-center items-center gap-10" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                    {ImpactData.map((item) => (
                        <div key={item.id} className="lg:w-[360px] w-[280px] duration-400 transi h-auto px-6 py-12 shadow-2xl rounded-lg border-4 border-gray-200 hover:border-[#58C229] cursor-pointer hover:-translate-y-4 bg-background text-primary flex flex-col gap-6">
                            <h1 className='text-center text-[18px] font-[500]'>{item.title}</h1>
                            <p className='text-[13px] text-justify text-foreground'>{item.desc}</p>
                        </div>
                    ))}
                </div>
            </div>
