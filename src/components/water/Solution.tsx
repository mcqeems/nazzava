          ...
          <div className=''>
            {WaterAccordion.map((item, i) => (
              <div key={i} className='mt-5' data-aos="fade-up" data-aos-duration="700" data-aos-delay="200">
                <div className={`bg-card w-[330px] lg:w-[660px] rounded-2xl overflow-hidden transition-all duration-700 bg-gray1 block mx-auto ${activeIndex === i ? 'max-h-[500px]' : 'lg:max-h-[65px] max-h-[82px]'} ${activeIndex !== null ? 'shadow-lg' : ''}`}>
                  <div 
