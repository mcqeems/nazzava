...
export default function Home() {
  return (
    <div className='flex lg:flex-row flex-col-reverse justify-center items-center w-full mb-12 lg:px-0 px-6 h-[110vh] lg:h-screen mx-auto lg:gap-24 gap-10 lg:pt-10 pt-24'>
      <div className="lg:w-150 w-full flex flex-col gap-6" data-aos="fade-right" data-aos-duration="900">
        <h1 className='text-[#0097DC] font-semibold lg:text-[42px] text-[24px]'>Jaga Kualitasnya, Selamatkan Masa Depan</h1>
      ...
      <div className="relative" data-aos="fade-left" data-aos-duration="900">
        <Image width={500} height={500} className='lg:w-125 bounce h-auto w-75' src='/image/water/water.webp' alt='tree'/>
