      ...
      <div className="flex lg:flex-row flex-col justify-center items-center gap-12 text-foreground">
        <div className="flex flex-col mt-16 justify-center items-center lg:gap-28 gap-46 lg:mr-0 mr-12">
          <div data-aos="fade-up" data-aos-duration="800">
            <div
              ...
              style={{ backgroundImage: `url('/image/water/comment.png')` }}
            >
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url('/image/water/comment-reverse.png')`,
            }}
          >
            <Image
              width={200}
