      ...
      <div className="flex lg:flex-row flex-col justify-center items-center gap-12 text-foreground">
        <div className="flex flex-col mt-16 justify-center items-center lg:gap-28 gap-50 lg:mr-0 mr-12">
          <div data-aos="fade-up" data-aos-duration="800">
            <div className="bg-cover relative hover:-translate-y-4 duration-500 object-cover w-[320px] lg:w-145 lg:h-45 h-25 flex justify-center items-center gap-6" style={{backgroundImage: `url('/image/dirt/comment.png')`}}>
              ...
              <Image width={200} height={200} className='absolute lg:w-50 w-25 -bottom-2 lg:-right-15 -right-10' src='/image/dirt/fact1.png' alt='fact'/>
            </div>
          </div>
          <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">            
            <div className="bg-cover relative hover:-translate-y-4 duration-500 object-cover w-[320px] lg:w-145 lg:h-45 h-25 flex justify-center items-center gap-6" style={{backgroundImage: `url('/image/dirt/comment.png')`}}>
              ...
              <Image width={220} height={220} className='absolute lg:w-65 w-35 lg:-bottom-11.5 -bottom-6 lg:-right-15 -right-10' src='/image/dirt/fact3.png' alt='fact'/>
            </div>
          </div>
        </div>
        <div className='lg:ml-0 ml-12' data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">          
          <div className="bg-cover relative hover:-translate-y-4 duration-500 object-cover w-[320px] lg:w-145 lg:h-45 h-25 lg:mt-0 -mt-76 flex justify-center items-center gap-6" style={{backgroundImage: `url('/image/dirt/comment-reverse.png')`}}>
            <Image width={200} height={200} className='absolute lg:w-45 w-25 bottom-2 lg:-left-10 -left-10px' src='/image/dirt/fact2.png' alt='fact'/>
